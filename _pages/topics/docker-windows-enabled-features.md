...
![Location of the "Programs and Features" item on the Control Panel](windows_cpanel_pnf.png)

## 2. Click on "Turn Windows features on or off"

On Hungarian systems, this is called "Windows-szolgáltatások be- és kikapcsolása".

![Location of the "Turn Windows features on or off" link](windows-cpanel-open-features.png)
...
|Hyper-V|WSL|
|---|---|
|![Hyper-V in the Features selection window](windows-features-hyperv.png)|![WSL in the Features selection window](windows-features-wsl.png)|
